...
const JoinPage = () => (
  <div>
    ...
    <div className={styles.row}>
      <Column title="Join Our Server" classes={classNames(styles.background_white, styles.box_shadow)}>
      ...
      <Column classes={classNames(styles.no_padding, styles.box_shadow)}>
